...
public partial class MainPage : ContentPage
{
    ...
    {
        selectedGender = "Male";
        MaleBorder.BorderColor = Colors.Blue; // Updated to use BorderColor
        FemaleBorder.BorderColor = Colors.Gray; // Updated to use BorderColor
    }

    private void OnFemaleTapped(object sender, EventArgs e)
    {
        selectedGender = "Female";
        FemaleBorder.BorderColor = Colors.Pink; // Updated to use BorderColor
        MaleBorder.BorderColor = Colors.Gray; // Updated to use BorderColor
    }
